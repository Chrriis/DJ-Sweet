...
public class WMPSettings {
  ...
  public int getVolume() {
    try {
      return (Integer)oleAccess.getOleProperty(new String[] {"settings", "volume"});
  ...
  public int getPlayCount() {
    try {
      return (Integer)oleAccess.getOleProperty(new String[] {"settings", "playCount"});
    } catch(IllegalStateException e) {
      // Invalid UI thread is an illegal state
      throw e;
    } catch(Exception e) {
  ...
  public float getPlaySpeedFactor() {
    try {
      return ((Double)oleAccess.getOleProperty(new String[]{"settings", "rate"})).floatValue();
    } catch(IllegalStateException e) {
      // Invalid UI thread is an illegal state
      throw e;
    } catch (Exception e) {
  ...
  public int getStereoBalance() {
    try {
      return (Integer)oleAccess.getOleProperty(new String[] {"settings", "balance"});
    } catch(IllegalStateException e) {
      // Invalid UI thread is an illegal state
      throw e;
    } catch(Exception e) {
