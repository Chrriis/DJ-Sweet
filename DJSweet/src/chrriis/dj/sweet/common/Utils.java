 ...
 */
package chrriis.dj.sweet.common;
...
public class Utils {
  ...
  public static String getLocalHostAddress() {
    synchronized(Utils.class) {
      ...
      String localHostAddress = SweetSystemProperty.LOCALHOSTADDRESS.get();
      ...
      if(localHostAddress == null) {
        boolean isDebugging = Boolean.parseBoolean(SweetSystemProperty.LOCALHOSTADDRESS_DEBUG_PRINTDETECTION.get());
        localHostAddress = getLocalHostAddress(0, isDebugging);
      }
      if(Boolean.parseBoolean(SweetSystemProperty.LOCALHOSTADDRESS_DEBUG_PRINT.get())) {
