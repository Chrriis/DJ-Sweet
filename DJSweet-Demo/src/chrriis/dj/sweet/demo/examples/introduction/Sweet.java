...
public class Sweet extends Composite {
  ...
  public Sweet(Composite parent) {
    ...
    editorPane.setText(
        "<html>" + LS +
        "  <body>" + LS +
        "    <h1>Why DJ Sweet?</h1>" + LS +
        "    <p>SWT is a nice user-interface toolkit, that allows access to native capabilities of various platforms.</p>" + LS +
        ...
        "      DJ Sweet is a port of this API to SWT, hence the similarities between the two projects.</p>" + LS +
        "  </body>" + LS +
        "</html>");
  }
